...
| 2 | Monde | Générateur de Caldria (graine 1087) : masse terrestre, Lloyd, provinces, fleuves, relief, hiérarchie comté → empire, noms ; validation | Fait |
| 3 | Scénario 1087 | 12 grandes maisons, ~680 personnages, titres, revendications, alliances, faction, guerre de départ, 9 départs recommandés | Fait |
...
| 7 | Client | Écran titre animé, authentification, paramètres, choix du souverain sur parchemin, multijoueur et salon, HUD complet, carte PixiJS (8 modes, zoom sémantique), panneaux, écrans, événements, audio procédural, tutoriel | Fait |
...
- Carte : brouillard de guerre et mini-carte.
